...
$(document).ready(function() {
	var best_crossword = generateCrossword(['crossword', 'ratty', 'owl', 'rosa', 'position', 'find', 'possible', 'word', 'Jonas', 'blue', 'computer']);
	console.log(best_crossword);	
	$('#test').html(best_crossword.testPrintGrid());
});
