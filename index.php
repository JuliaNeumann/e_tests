...
?>
		<button type="submit" name="test_type_button" class="test_type_button" value="<?php echo $type['type_string']; ?>">
...
?>
		<button type="submit" name="test_type_button" class="test_type_button" value="new_idea" id="new_idea_button">
